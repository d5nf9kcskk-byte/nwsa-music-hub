...
export const WHATS_NEW: WhatsNewEntry[] = [
  ...
  // chart can announce itself to its group.
  {
    ...
    bullets: [
      ...
      'Every seating chart now has its own link. Copy it from the chart editor, or from the \u2261 button beside a chart in the list, and paste it into a text, an email, or an announcement. The \u201cAnnounce this to \u2026\u201d button attaches it for you.',
  ...
  // and the lesson grade is a number (#applied).
  {
    ...
    bullets: [
      ...
      'The family email is yours to send, per line, and it now actually sends. Saving a finished lesson only offers it — press "Email the family" and the student and their guardians get that lesson by email, or say Not now and nothing goes. Every finished row keeps an envelope button, and the row says "Emailed Sep 3" or "Not emailed" so you never have to guess whether a family already had it.',
    ],
  },
