...
import { rotationSummary } from './rotations';
...
function StudentPanel({ student, ensembles, onBack, prefill, autoOpenForm, onNavigate }: {
  student: Student;
  ensembles: Ensemble[];
  onBack: () => void;
  prefill?: Prefill;
    ...
    <div className="dir-tab-page">
      ...
      {menuOpen && (
        <VerbMenu
          ...
          onPick={v => {
            setMenuOpen(false);
            // Rotations have their own reference page (Phase 4d, doc §4) —
            // every standing rotation is listed, edited, and added there.
            if (v === 'rotation') { onNavigate?.('rotations', { studentId: student.id }); return; }
            setVerb(v);
          }}
