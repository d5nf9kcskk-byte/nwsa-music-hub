...
export type DirTab = Tab | 'scheduleChanges' | 'scheduleSwap' | 'rotations' | 'announcements' | 'today' | 'ensembleHub' | 'ensembles' | 'classes' | 'college' | 'whosOut' | 'documents' | 'lessons' | 'myLessons' | 'messages' | 'signups' | 'personnel' | 'juries' | 'concerts' | 'concertCheckin' | 'gradebook' | 'approvals' | 'copyRequests' | 'directors';
