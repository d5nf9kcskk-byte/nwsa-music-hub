...
export type DirTab = Tab | 'scheduleChanges' | 'scheduleSwap' | 'announcements' | 'today' | 'ensembleHub' | 'ensembles' | 'whosOut' | 'documents' | 'lessons' | 'messages' | 'signups' | 'personnel' | 'juries';
