...
const EVENTS = [
  ...
  ev('music-showcase-dec-1', 'Concert', ALL_MUSIC, '2026-12-09', '09:45', V.chapman,
    'NWSA Music Showcase Concert',
    'Morning education & recruitment concert — visiting schools attend. First session 9:45–10:45am.', { endTime: '10:45' }),
  ev('music-showcase-dec-2', 'Concert', ALL_MUSIC, '2026-12-09', '11:15', V.chapman,
    'NWSA Music Showcase Concert',
    'Morning education & recruitment concert — visiting schools attend. Second session 11:15am–12:15pm.', { endTime: '12:15' }),
